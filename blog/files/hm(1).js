(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "6644cb52cdff5df841fbded98846b7af",
        dm: ["mangoya.cn"],
    ...
    mt.cookie.set = function(a, b, g) {
        var d;
        g.P && (d = new Date,
        d.setTime(d.getTime() + g.P));
        document.cookie = a + "=" + b + (g.domain ? "; domain=" + g.domain : "") + (g.path ? "; path=" + g.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (g.Dc ? "; secure" : "")
    }
    ;
    ...
    (function() {
                    ...
                    if (!("html" === m || "body" === m)) {
                        ...
                        if (p)
                            ...
                            for (var s = 0, t = 0, q = e.childNodes.length; t < q; t++) {
                                var w = e.childNodes[t];
                                1 === w.nodeType && w.nodeName.toLowerCase() === m && s++;
                                if (1 < s)
                                    return v
                            }
                            if (1 !== s)
        ...
        ;
        mt.f.ua = function(a) {
            return (a = mt.f.ta(a, u)) && a.length ? String(a[0]) : ""
        }
        ;
        mt.f.Kb = function(a) {
            return mt.f.ta(a, x)
        ...
        mt.f.Ib = function(a) {
            ...
            if (!a)
                return d;
            var b = mt.f.Cb(a).documentElement;
        ...
        mt.f.R = function(g, d) {
            var e;
            a.G(g) && 0 === String(g).indexOf("!HMCQ!") ? (e = String(g),
            e = b.m(document.location.href, e.substring(6, e.length))) : a.G(g) || (e = mt.f.S(g),
            ...
            e = e(g, "alt") || e(g, "title") || e(g, "src")) : e = "body" === e || "html" === e ? ["(hm-default-content-for-", e, ")"].join("") : mt.f.Nb(g));
    ...
    (function() {
        var a = mt.event;
        mt.g = {};
        mt.g.ya = /msie (\d+\.\d+)/i.test(navigator.userAgent);
        mt.g.Hb = function() {
        ...
        mt.g.fc = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    ...
    ;
    h.C = {
        Ac: "http://tongji.baidu.com/hm-web/welcome/ico",
        Za: "hm.baidu.com/hm.gif",
        pb: /^(tongji|hmcdn).baidu.com$/,
        hb: "tongji.baidu.com",
        Tb: "hmmd",
        Ub: "hmpl",
        rc: "utm_medium",
        ...
        vc: 1,
        Aa: 2147483647,
        gb: "hca kb cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn p ct u tt".split(" "),
        U: u,
        Ia: ["a", "input", "button"],
        Fa: {
            id: "data-hm-id",
        ...
        var a = mt.lang
          ...
          , m = {
            ...
            r: function(b) {
                ...
                m.Ba()) : "user" === b && a.d(d.user, "Object") ? (b = d.user.uid_,
                d.user = b === r ? {} : {
                    uid_: b
                },
                m.Ba()) : d[b] !== r && (d[b] = {}))
        ...
        if (b.isArray(c.cptrk) && 0 < c.cptrk.length) {
            var f = {
                ...
                Wa: function() {
                    var d, b, e;
                    for (e in f.ha)
                        if (f.ha.hasOwnProperty(e) && f.Xa[e] === r && (d = f.ha[e],
                        d = a.ra(d)))
                            b = b === r ? {} : b,
                            b[e] = a.R(d, x),
                            f.Xa[e] = u;
            ...
            aa: function(a, e) {
                return function(l) {
                    ...
                    if (f) {
                        ...
                        else if (e && 0 < e.length && (f = b.Kb(f)) && f.length)
                            if (m = f.length,
                            l = f[f.length - 1],
          ...
          , p = {
            ...
            jb: function() {
                if (c.cetrk && c.cetrk.length) {
                    g.e(document, "click", l.aa(p, c.cetrk));
            ...
            s: function(b, e) {
                ...
                w = p.Bb(w, e || b && b.p);
                w._iden = g;
                f.setProperty("customEvent", w);
                h.c.b.ep = "";
                h.c.b.p = m(f.z("customEvent"));
                h.c.i();
                h.c.b.p = "";
                f.r("customEvent")
            },
            Bb: function(b, d) {
                ...
                b.ec_ = a.getAttribute(f, g.$) || a.getAttribute(f, "class") || "",
                b.ex_ = a.getAttribute(f, g.Z) || a.ua(f),
                b.en_ = a.getAttribute(f, g.content) || a.R(f, u),
                b.et_ = a.getAttribute(f, g.ga) || a.S(f),
                b.el_ = a.getAttribute(f, g.link) || a.getAttribute(f, "href") || "") : (b.ex_ = a.getAttribute(f, g.Z) || a.ua(f),
                b.en_ = a.getAttribute(f, g.content) || a.R(f, u)));
                return b
            },
            Lb: function(b, d) {
        ...
        var a = mt.lang
          ...
          , t = {
            aa: function() {
                return function(d) {
                    if (h.c && h.c.U && c.aet && c.aet.length) {
                        ...
                        if (f) {
                            var k = h.c.Ia
                              , n = b.getAttribute(f, e.Ha) != v ? u : x;
                            if (b.getAttribute(f, e.Ga) == v)
                                if (n)
                                    t.la(t.sa(f, d));
                                else {
                                    var y = b.S(f);
                                    if (a.F(k, "*") || a.F(k, y))
                                        ...
                                        for (; f.parentNode != v; ) {
                                            var n = f.parentNode
                                              , y = b.S(n)
                                              , z = "a" === y && a.F(k, "a") ? u : x
                                              , y = "button" === y && a.F(k, "button") ? u : x
                                              , A = b.getAttribute(n, e.Ha) != v ? u : x;
                                            if (b.getAttribute(n, e.Ga) == v && (z || y || A)) {
                                                t.la(t.sa(n, d));
                                                break
                                            }
                                            f = f.parentNode
            ...
            sa: function(f, g) {
                ...
                k.$ = b.getAttribute(f, n.$) || b.getAttribute(f, "class") || "";
                k.Z = b.getAttribute(f, n.Z) || b.ua(f);
                k.content = b.getAttribute(f, n.content) || b.R(f, u);
                k.ga = b.getAttribute(f, n.ga) || b.S(f);
                k.link = b.getAttribute(f, n.link) || b.getAttribute(f, "href") || "";
                k.type = g.type || "click";
                n = a.Ra(f.offsetTop) ? f.offsetTop : 0;
                "click" === g.type ? n = d.ya ? g.clientY + Math.max(document.documentElement.scrollTop, document.body.scrollTop) : g.pageY : "touchend" === g.type && (g.Va && g.Va.changedTouches) && (n = g.Va.changedTouches[0].pageY);
                k.oc = n;
                n = this.Db(g);
                k.Ta = n.Ta || 0;
                k.Ua = n.Ua || 0;
            ...
            Db: function(f) {
                ...
                z = A.left,
                A = A.top,
                a.d(e.getBBox, "Function") && (y = e.getBBox(),
                n = y.width,
                y = y.height),
                "html" === (e.tagName || "").toLowerCase()))
                    n = Math.max(n, e.clientWidth),
                    y = Math.max(y, e.clientHeight);
                return {
                    Ta: Math.round(100 * ((g - z) / n)),
                    Ua: Math.round(100 * ((f - A) / y)),
                    ib: n,
                    Oa: y,
                    fb: ("a" === (e.tagName || "").toLowerCase() ? e : b.Ab(e)) ? "a" : "b"
                }
            },
            la: function(b) {
                var d = a.h;
                b = [+new Date - (h.c.W !== r ? h.c.W : p), d(b.id), d(b.$), d(b.ga), d(b.Z), d(b.link), d(b.content), b.type, b.oc].join("*");
                t.ma(b);
                a.d(this.Y(), "Function") && this.Y()()
            },
            ma: function(a) {
                a.length > e.na || (encodeURIComponent(s.join("!") + a).length > e.na && (t.s(s.join("!")),
                s = []),
                s.push(a))
            },
            s: function(a) {
                h.c.b.et = 5;
                h.c.b.ep = a;
                h.c.b.p = m(f.z("autoEventTracking"));
                h.c.i();
                h.c.b.p = ""
            },
            Y: function() {
                return function() {
                    s && s.length && (t.s(s.join("!")),
                    s = [])
                }
            }
        };
        a.G(c.aet) && "" !== c.aet && l.e("pv-b", function() {
            g.e(document, "click", t.aa());
            "ontouchend"in document && g.e(window, "touchend", t.aa());
            g.e(window, "unload", t.Y())
        });
        return t
    }
    )();
    (function() {
        var a = mt.lang
          ...
          , p = {
            nb: function() {
                a.G(c.aet) && "" !== c.aet && setInterval(p.bb, d.gc)
            },
            bb: function() {
                var a = g.T() + g.L();
          ...
          , s = {
            wb: function() {
                return function() {
                    h.c && (h.c.U && c.aet && c.aet.length) && (window.clearTimeout(m),
            ...
            mb: function(a) {
                s.ma([+new Date - (h.c.W !== r ? h.c.W : l), a].join("*"))
            },
            ma: function(a) {
                if (encodeURIComponent(f.join("!") + a).length > d.na || 3 < f.length)
                    s.s(f.join("!")),
                    f = [];
                f.push(a)
            },
            ...
            Y: function() {
                return function() {
                    f && f.length && (s.s(f.join("!")),
                    f = [])
                }
            }
        };
        a.G(c.aet) && "" !== c.aet && e.e("pv-b", function() {
            b.e(window, "scroll", s.wb());
            b.e(window, "unload", s.Y());
            p.nb()
        });
        return s
    }
    ...
    (function() {
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                s = "focus" == a.type || "focusin" == a.type ? u : x,
                b()
        }
        var e = mt.event, l = h.w, f = u, m = u, p = u, s = u, t = +new Date, q = t, w = 0, k = u, n = g("visibilityState"), y = g("hidden"), z;
        b();
        (function() {
          ...
          , k = {
            ...
            init: function() {
                ...
                m.e("stag-b", function() {
                    ...
                    h.c.b.ct = [decodeURIComponent(t.getData("Hm_ct_" + c.id) || ""), k.B.Ea, k.B.page].join("!")
                });
                m.e("stag-d", function() {
                    h.c.b.api = 0;
                    k.j = 0;
            ...
            yb: function() {
                if (0 < k.X.length)
                    for (var a = 0, b = k.X.length; a < b; a++)
                        k.Ca(k.X[a]);
                k.X = v
            },
            Ca: function(a) {
            ...
            _clearAutoEventTrackingProperty: function(a) {
                1 < a.length && u === a[1] && q.r("autoEventTracking")
            },
            ...
            _providePlugin: function(a) {
                if (1 < a.length) {
                    var b = window._hmt
                      , e = a[1];
                    a = a[2];
                    if (d.F(f.Ya, e) && d.d(a, "Function") && (b.plugins = b.plugins || {},
                    b.H = b.H || {},
                    b.plugins[e] = a,
                    b.A = b.A || [],
                    a = b.A.slice(),
                    e && a.length && a[0][1] === e))
                        for (var g = 0, k = a.length; g < k; g++) {
                            var l = a[g][2] || {};
                            if (b.plugins[e] && !b.H[e])
                                b.H[e] = new b.plugins[e](l),
                                b.A.shift();
                            else
                                break
                        }
            ...
            _requirePlugin: function(a) {
                if (1 < a.length) {
                    ...
                    if (d.F(f.Ya, e))
                        ...
                        b.H = b.H || {},
                        b.plugins[e] && !b.H[e])
                            b.H[e] = new b.plugins[e](g);
                        else {
                            b.A = b.A || [];
                            for (var g = 0, l = b.A.length; g < l; g++)
                                if (b.A[g][1] === e)
                                    return;
                            b.A.push(a);
                            k._require([v, f.dc + e + ".js"])
                        }
                }
            },
    ...
    (function() {
        function a() {
            ...
            this.Qa = this.Pa = u,
            this.U = k.U,
            this.Ia = e.G(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "",
            this.xa = x,
            this.init())
        }
        var b = mt.url
        ...
        a.prototype = {
            ...
            Mb: function() {
                if (!document.referrer)
                    return k.I - k.M > c.vdur ? 1 : 4;
                var a = x;
                this.ca(document.referrer) && this.ca(document.location.href) ? a = u : (a = b.K(document.referrer),
                a = this.V(a || "", document.location.hostname));
                return a ? k.I - k.M > c.vdur ? 1 : 4 : 3
            },
            lc: function() {
                var a, b, d, e, f, g;
                ...
                if (g = t.getData("Hm_lvt_" + c.id)) {
                    ...
                    e = "",
                    f = 1;
                this.Zb() ? (t.setData("Hm_lvt_" + c.id, g, c.age),
                t.setData("Hm_lpvt_" + c.id, k.I),
                d = l.bc(this.Q(), this.ba())) : this.zb();
            ...
            Zb: function() {
                var a = b.K(document.location.href);
                return !e.F("sjh.baidu.com isite.baidu.com ls.wejianzhan.com bs.wejianzhan.com product.weijianzhan.com qianhu.weijianzhan.com aisite.wejianzhan.com".split(" "), a)
            },
            zb: function() {
            ...
            kc: function() {
                for (var a = [], b = this.b.et, d = 0, e = k.gb.length; d < e; d++) {
                    var f = k.gb[d]
                      , g = this.b[f];
            ...
            mc: function() {
                ...
                this.b.cp = b.m(a, k.Ub) || b.m(a, k.rc) || "";
                this.b.cw = b.m(a, k.Sb) || b.m(a, k.tc) || "";
                this.b.ci = b.m(a, k.Qb) || b.m(a, k.qc) || "";
                this.b.cf = b.m(a, k.Vb) || b.m(a, k.sc) || "";
                this.b.cu = b.m(a, k.Rb) || b.m(a, k.pc) || "";
                f.$b() && (this.b.u = window.location.href)
            },
            init: function() {
                try {
                    this.mc(),
                    0 === this.b.nv ? this.jc() : this.Ka(),
                    h.c = this,
                    this.tb(),
                    this.rb(),
                    y.J("pv-b"),
            ...
            tb: function() {
                var a = document.location.hash.substring(1)
                  , d = RegExp(c.id)
                  , e = b.K(document.referrer) === k.hb ? 1 : 0
                  , f = b.m(a, "jn")
            ...
            rb: function() {
                if (window.postMessage && window.self !== window.parent) {
                    ...
                    s.e(window, "message", function(d) {
                        if (b.K(d.origin) === k.hb) {
                            d = d.data || {};
                            var e = d.jn || ""
                              , f = /^customevent$|^heatmap$/.test(e);
            ...
            ab: function(a) {
                ...
                if (b.length) {
                    ...
                    b.length ? m.set("Hm_unsent_" + c.id, p.stringify(b)) : this.Ka()
                }
            },
            Ka: function() {
    ...
    (function() {
        var a = mt.g
          ...
          , g = mt.event
          , d = mt.o;
        if ("undefined" !== typeof h.c && (c.med || (!a.ya || 7 < a.Hb()) && c.cvcc)) {
            ...
            if ("undefined" !== typeof m && "undefined" !== typeof f) {
                ...
                g.e(document, "mousedown", function(a) {
                    a = a || window.event;
                    w = a.target || a.srcElement;
                    var d = {};
                    for (s(m, function(a, e) {
                        d[a] = b.d(e, "Function") ? e() : document.getElementById(e)
                    }); w && w !== document && s(d, k) !== x; )
                        w = w.parentNode
                })
            }
        }
            ...
            var e = {
                lb: function() {
                    for (var b = c.cvcf.length, d, m = 0; m < b; m++)
                        (d = a.La(decodeURIComponent(c.cvcf[m]))) && g.e(d, "click", e.qa())
                },
                qa: function() {
                    return function() {
                        h.c.b.et = 86;
